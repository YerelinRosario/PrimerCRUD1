...
using PrimerCRUD1.Models;

namespace PrimerCRUD1.Controllers
{
    public class UsuariosController : Controller
    {
        private readonly PrimerCrudContext _context;

        public UsuariosController(PrimerCrudContext context)
        {
            _context = context;
        }
